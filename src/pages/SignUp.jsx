  ...
  return (
    ...
    <div>
      ...
      <div className="loginregister">
        <form>
            <div className="form-floating mb-3 input_box"><input name="email" type="email" placeholder="name@example.com" value={email} onChange={onEmailHandler} className="form-control"/><label for="floatingInput">Email address</label></div>
